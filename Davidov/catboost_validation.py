...
if __name__ == '__main__':
    ...
    X_test_path = input_dir / 'X_val.csv'
    y_test_path = input_dir / 'y_val.csv'
    ...
    print(f"Валидация модели CatBoost ")
    print("-------------------------------")
    print("средняя абсолютная ошибка относительно среднего значнения: ", mean_absolute_error(y_test, y_pred_baseline))
    print("абсолютная средняя ошибка модели: ", mean_absolute_error(y_test, y_pred_catboost))