...
if __name__ == '__main__':
    ...
    baseline_model = load(baseline_model_path) # Идея сравнения с baseline проста: моя новая модель должна как минимум быть не хуже, чем базовый подход
    ...
    print("средняя абсолютная ошибка относительно среднего значнения: ", mean_absolute_error(y_test, y_pred_baseline))
    print("абсолютная средняя ошибка модели: ", mean_absolute_error(y_test, predicted_values))
