...
if __name__ == '__main__':
    ...
    print("средняя абсолютная ошибка относительно среднего значнения: ", mean_absolute_error(y_val, y_pred_baseline))
    print("абсолютная средняя ошибка модели: ", mean_absolute_error(y_val, predicted_values))