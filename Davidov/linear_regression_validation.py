...
if __name__ == '__main__':
    ...
    print("Средняя квадратичная ошибка модели:",mean_squared_error(y_val, predicted_values))
    print("Средняя абсолютная ошибка модели:", mean_absolute_error(y_val, predicted_values))