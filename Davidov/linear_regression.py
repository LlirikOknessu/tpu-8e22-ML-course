...
if __name__=="__main__":
    ...
    print("среднее значение целевой пременной: ", y_mean)
    print("Средняя квадратичная ошибка модели:",mean_squared_error(y_test, predicted_values))
    print("Средняя абсолютная ошибка модели:", mean_absolute_error(y_test, predicted_values))
    ...
    print("константа свдига:", intercept)
